...
<li ref={ref} className='col-span-9 lg:col-span-6 ml-12 py-12 lg:ml-10 justify-left font-medium text-left dark:text-light rounded-2xl border border-solid dark:border-dark bg-dark/10 dark:bg-light/20 p-6 shadow-md shadow-dark/50'> 
