...
<li ref={ref} className='col-span-9 lg:col-span-4 lg:-ml-16 justify-left font-medium text-left dark:text-light rounded-2xl border border-solid dark:border-dark bg-dark/10 dark:bg-light/20 p-6 shadow-md shadow-dark/50'> 
