...
<h1>
< AnimatedText text="I'm Awais Ahmad" className="!text-6xl  text-dark dark:text-light font-bold text-left lg:!text-xl lg:w-full lg:!text-center md:!text-3xl sm:!text-6xl"/>
</h1>
<h4 className="text-4xl text-dark dark:text-light font-bold pt-5 text-start lg:text-center lg:text-lg md:text-3xl sm:text-2xl">
<Typewriter
  options={{
